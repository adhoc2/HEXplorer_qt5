...
RECORD_LAYOUT::RECORD_LAYOUT(QTextStream &in, Node *parentNode)
...
void RECORD_LAYOUT::parseFixPar(QList<TokenTyp> *typePar, QTextStream &in)
{
...
TokenTyp RECORD_LAYOUT::parseOptPar(QTextStream &in)
{
    //opt parameters
