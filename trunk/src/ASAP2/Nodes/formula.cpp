...
FORMULA::FORMULA(QTextStream &in, Node *parentNode)
...
void FORMULA::parseFixPar(QList<TokenTyp> *typePar, QTextStream &in)
{
...
TokenTyp FORMULA::parseOptPar(QTextStream &in)
{
    //opt parameters
