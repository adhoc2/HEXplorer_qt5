...
STATUS_STRING_REF::STATUS_STRING_REF(QTextStream &in, Node *parentNode)  : Item(parentNode)
{
    //get grammar
...
void STATUS_STRING_REF::parseFixPar(QList<TokenTyp> *typePar,  QTextStream &in)
{
