...
MEMORY_LAYOUT::MEMORY_LAYOUT( Node *parentNode)
...
void MEMORY_LAYOUT::parseFixPar(QList<TokenTyp> *typePar)
{
...
TokenTyp MEMORY_LAYOUT::parseOptPar(QMap<std::string, Occurence> *nameOptPar)
{
