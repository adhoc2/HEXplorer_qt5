...
AXIS_DESCR::AXIS_DESCR(QTextStream &in, Node *parentNode)
...
void AXIS_DESCR::parseFixPar(QList<TokenTyp> *typePar, QTextStream &in)
{
...
TokenTyp AXIS_DESCR::parseOptPar(QMap<std::string, Occurence> *nameOptPar, QTextStream &in)
{
