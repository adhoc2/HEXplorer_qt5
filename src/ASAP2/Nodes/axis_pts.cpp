...
AXIS_PTS::AXIS_PTS(QTextStream &in, Node *parentNode)
...
void AXIS_PTS::parseFixPar(QList<TokenTyp> *typePar, QTextStream &in)
{
...
TokenTyp AXIS_PTS::parseOptPar(QMap<std::string, Occurence> *nameOptPar, QTextStream &in)
{
