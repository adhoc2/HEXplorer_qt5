...
MOD_COMMON::MOD_COMMON(QTextStream &in, Node *parentNode)
...
void MOD_COMMON::parseFixPar(QList<TokenTyp> *typePar, QTextStream &in)
{
...
TokenTyp MOD_COMMON::parseOptPar(QTextStream &in)
{
    //opt parameters
