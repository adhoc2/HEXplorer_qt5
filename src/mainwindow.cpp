...
MainWindow::MainWindow()
{
    ...
    connect(autoRefreshAct, SIGNAL(toggled(bool)), settingsTree, SLOT(setAutoRefresh(bool)));
    autoRefreshAct->setChecked(true);
    autoRefreshAct->setVisible(false);

    connect(fallbacksAct, SIGNAL(toggled(bool)), settingsTree, SLOT(setFallbacksEnabled(bool)));
